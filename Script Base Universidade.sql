...
ALTER TABLE Predio
ADD FOREIGN KEY (IdUniversidade) REFERENCES Universidade(IdUniversidade) ON DELETE SET NULL
GO
...
ALTER TABLE Funcionario
ADD FOREIGN KEY (IdDepartamento) REFERENCES Departamento(IdDepartamento) ON DELETE SET NULL
GO
...
ALTER TABLE Semestre
ADD FOREIGN KEY(IdPredio) REFERENCES Predio(IdPredio) ON DELETE SET NULL
GO
...
ALTER TABLE Ministra
ADD FOREIGN KEY(IdProfessor) REFERENCES Professor(IdProfessor) ON DELETE SET NULL
GO
...
ALTER TABLE Biblioteca
ADD FOREIGN KEY (IdFuncionario) REFERENCES Funcionario(IdFuncionario) ON DELETE SET NULL
GO
...
ALTER TABLE Livro
ADD FOREIGN KEY (IdBiblioteca) REFERENCES Biblioteca(IdBiblioteca) ON DELETE SET NULL
GO

ALTER TABLE Livro
ADD FOREIGN KEY (IdCategoria) REFERENCES Categoria(IdCategoria) ON DELETE SET NULL
GO

ALTER TABLE Livro
ADD FOREIGN KEY (IdEditora) REFERENCES Editora(IdEditora) ON DELETE SET NULL
GO

ALTER TABLE Livro
ADD FOREIGN KEY (IdAutor) REFERENCES Autor(IdAutor) ON DELETE SET NULL
GO
...
ALTER TABLE Reserva
ADD FOREIGN KEY (IdLivro) REFERENCES Livro(IdLivro) ON DELETE SET NULL
GO

ALTER TABLE Reserva
ADD FOREIGN KEY (IdAluno) REFERENCES Aluno(IdAluno) ON DELETE SET NULL
GO
...
ALTER TABLE Emprestimo
ADD FOREIGN KEY (IdBibliotecaRetirada) REFERENCES Biblioteca(IdBiblioteca) ON DELETE SET NULL
GO

ALTER TABLE Emprestimo
ADD FOREIGN KEY (IdBibliotecaDevolucao) REFERENCES Biblioteca(IdBiblioteca) ON DELETE SET NULL
GO
